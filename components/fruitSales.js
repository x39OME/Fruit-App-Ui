...
export default function fruitSales({fruit}) {
  ...
  return (
    <View className="mr-6">
      ...
      <View style={{backgroundColor: fruit.color(0.4), height: 75, width: 80}} className={` rounded-3xl flex justify-end items-center`}>
