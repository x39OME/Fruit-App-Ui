...
export default function fruitCard({fruit}) {
  ...
  return (
    <View style={{width:270, borderRadius:40, backgroundColor: fruit.color(1)}} className={`mx-4`}>
      ...
      <View className="flex-row justify-center" style={{
          ...
          <Image source={fruit.image} style={{backgroundColor:'transparent', width: 210, height: 210}} />
      </View>
